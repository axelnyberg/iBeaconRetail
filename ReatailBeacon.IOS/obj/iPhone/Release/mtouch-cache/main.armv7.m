...
extern void *mono_aot_module_ReatailBeaconIOS_info;
extern void *mono_aot_module_Xamarin_Estimote_iOS_info;
...
{
	mono_aot_register_module (mono_aot_module_ReatailBeaconIOS_info);
	mono_aot_register_module (mono_aot_module_Xamarin_Estimote_iOS_info);
...
{
	xamarin_open_and_register ("Xamarin.Estimote.iOS.dll");
...
void xamarin_setup ()
{
	...
	xamarin_executable_name = "ReatailBeaconIOS.exe";
