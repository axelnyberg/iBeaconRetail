...
void xamarin_create_classes () {
	...
	__xamarin_class_map [41].handle = objc_getClass ("UITabBar");
	__xamarin_class_map [42].handle = objc_getClass ("UITabBarController");
	__xamarin_class_map [43].handle = objc_getClass ("UIWebView");
